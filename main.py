...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden_layers", type=int, default=4, help="the number of hidden layers")
    parser.add_argument("--nheads", type=int, default=6, help="the number of heads attention")
